...
{
    class ImportJob_GH615
    {
        public ImportJob_GH615(string sourceDescription, DeviceConfigurationInfo configInfo, IJobMonitor monitor, IImportResults importResults)
        {
        ...
        public bool Import()
        {
            ...
            try
            {
                ...
                if (configInfo.ImportOnlyNew && Plugin.Instance.Application != null && Plugin.Instance.Application.Logbook != null)
                {
                    ...
                    foreach (List<Gh615Packet.TrackFileHeader> dateHeaders in headersByStart.Values)
                    {
