...
namespace ZoneFiveSoftware.SportTracks.Device.Globalsat
{
    ...
    {
        public GlobalsatPacket(GlobalsatProtocol device)
        {
            this.Device = device;
        }
        ...
        public virtual System.Drawing.Bitmap ResponseGetScreenshot(System.Drawing.RotateFlipType rotateFlip) { return GlobalsatBitmap.GetBitmap(this.Device.ScreenBpp, this.Device.ScreenSize, this.Device.ScreenRowCol, rotateFlip, this.PacketData); }
    ...
    {
        public GlobalsatPacket2(GlobalsatProtocol device) : base(device) { }
