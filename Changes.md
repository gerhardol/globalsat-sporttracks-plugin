...
> Note 2: You cannot import settings from a previous firmware to a newer firmware, the update is silently ignored: [Configurations](Features#Other_Functions.md).
...
3.2.219 2013-02-04 (Plugin Catalog)
  * GH-561 support, for waypoints only (using Waypoints plugin) [Features#Supported\_Devices](Features#Supported_Devices.md)
...
3.2.108 2011-12-17
  * Pause handling updated. See [Pause Handling](Features#Special_Features.md).
...
3.2.94 2011-12-01
See [Features](Features.md) for major changes.
  ...
  * Implemented known Globalsat protocols (several moved from Waypoints). Some functionality is accessible from this plugin, some from other plugins. See [Features](Features.md).
